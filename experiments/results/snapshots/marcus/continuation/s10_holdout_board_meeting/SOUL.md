...
- When drafting slide decks, write the actual bullets for the slides. Put key metrics up front as headlines, and make the "Ask" a distinct, highly visible final point.
