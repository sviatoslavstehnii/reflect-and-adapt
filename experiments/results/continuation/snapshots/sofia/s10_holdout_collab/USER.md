...
- **Aesthetic Preferences:** Cozy, tactile, 'lo-fi scrapbook' style with earthy tones and ripped-paper elements; avoids generic tech styles
...
- **Video Descriptions:** Includes gear links and FAQs at the bottom

## Tools & Workflows

- **Project Management:** Uses Notion for their backlog
- **Channel Stats Location:** Data folder
- **Channel Stats File:** `channel_stats.json`
- **Design Tools:** Uses Canva for Instagram carousels
...
- **Physical Features:** Soft, medium-length wavy brown hair, fair warm-toned skin
